...
import { getSingleGarage, getOpeningHoursByGarageId, upsertOpeningHours } from '@/lib/supabase/queries'
import type { OpeningHours } from '@/types'

/**
 * GET /api/opening-hours
 * Returns opening hours for the garage (public access)
 */
 ...
 * Upserts opening hours for the garage (protected by ADMIN_WRITE_SECRET)
 */
